              ...
              <div className="row">
                <div className="col-xxl-8 col-xl-8 col-lg-9 mb-lg-0 mb-24">
                  ...
                  <ul className="tag unstyled mb-24">
                    <li>18+</li>
                    <li>HD</li>
                    <li>{details.aired.prop.from.year}</li>
                    <li>{details.producers[0].type}</li>
                ...
                <div className="col-xxl-3 col-xl-4 col-lg-3" style={{textAlign:"left"}}>
                  <div className="about">
                    ...
                    <p className="sec color-white mb-8">
                      <span className="color-medium-gray">Director:</span> Bones
                    </p>
                    <p className="sec color-white mb-8">
                      <span className="color-medium-gray">Date aired:</span> {details.aired.string}
                    </p>
                    <p className="sec color-white mb-8">
                    ...
                    <p className="sec color-white mb-24">
                      <span className="color-medium-gray">Duration:</span> {details.duration}
                      min
                    </p>
